...
export const EVAL_CRITERIA_DATA = [
  {id:"quality",       name:"جودة العمل",               leadership:false, levels:{2:"مقبول لكنه يحتاج مراجعة متكررة",3:"جيدة مع أخطاء بسيطة نادرة",4:"عالية ودقيقة",5:"استثنائي يُعتمد مرجعاً للآخرين"}},
  {id:"productivity",  name:"الإنتاجية",                leadership:false, levels:{2:"ينجز الحد الأدنى في الوقت",3:"ينجز المهام في مواعيدها بانتظام",4:"يتجاوز الأهداف باستمرار",5:"إنجازات غير مسبوقة وأساليب جديدة"}},
  {id:"initiative",    name:"المبادرة",                  leadership:false, levels:{2:"يتطلب توجيهاً مستمراً لبدء المهام",3:"يبادر أحياناً ويقترح حلولاً بسيطة",4:"يبادر باستمرار ويقدم حلولاً مبتكرة",5:"يُحدث تحولات إيجابية ويقود التغيير"}},
  {id:"teamwork",      name:"التعاون والعمل الجماعي",    leadership:false, levels:{2:"تعامل محدود ويسبب احتكاكاً أحياناً",3:"يتعاون جيداً ويساهم في أهداف الفريق",4:"يعزز روح الفريق ويساعد الآخرين تطوعاً",5:"يبني شراكات ويحل النزاعات ويوحد الجهود"}},
  {id:"attendance",    name:"الالتزام والحضور",           leadership:false, levels:{2:"غيابات متكررة وتأخيرات مع عذر",3:"حضور منتظم مع تأخيرات نادرة",4:"التزام تام بالدوام وقواعد العمل",5:"نموذج يُحتذى في الانضباط ويشجع الآخرين"}},
  {id:"learning",      name:"التعلم والتطوير",            leadership:false, levels:{2:"مقاومة للتغيير ويتطلب ضغطاً للتطوير",3:"يستجيب للتدريب ويطبق ما تعلمه",4:"يطور نفسه تطوعاً ويسعى للمعرفة",5:"يصبح خبيراً ويدرب الآخرين ويبني المعرفة"}},
  {id:"communication", name:"التواصل",                   leadership:false, levels:{2:"غير واضح يسبب سوء فهم",3:"يعبّر بوضوح ويستمع بشكل جيد",4:"يوازن بين الإقناع والاستماع ويتقن التواصل",5:"يُلهم الآخرين ويفاوض ويقنع ببراعة"}},
  {id:"problem",       name:"حل المشكلات",               leadership:false, levels:{2:"يتجاهل المشكلات أو يحيلها للآخرين",3:"يحل المشكلات الروتينية بفعالية",4:"يحل المعقدة ويحلل جذورها",5:"يتنبأ ويحول التحديات لفرص"}},
  {id:"innovation",    name:"الابتكار والإبداع",          leadership:false, levels:{2:"يتبع الأساليب التقليدية دون تعديل",3:"يحسّن العمليات القائمة تدريجياً",4:"يقدم أفكاراً جديدة تُطبق بنجاح",5:"يُحدث اختراقات إبداعية تغير قواعد اللعبة"}},
  {id:"leadership",    name:"القيادة",                    leadership:true,  levels:{2:"لا يُظهر أي مؤشرات قيادية",3:"يقود المهام المكلف بها بنجاح",4:"يُلهم الفريق ويوزع الأدوار ويحقق النتائج",5:"يبني قادة ويؤسس ثقافة قيادية مؤسسية"}},
];
